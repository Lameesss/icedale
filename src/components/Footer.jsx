...
export default function Footer() {
  ...
  return (
    <footer className={`w-full min-h-[60vh] lg:h-[calc(100vh-64px)] bg-blue-900 text-white flex flex-col justify-between py-6 lg:py-16 px-4 sm:px-6 lg:px-6 overflow-hidden ${outfit.className}`}>
