        ...
        <div id="features" className={cn("relative flex flex-col items-center justify-center w-full py-20", outfit.className)}>
            ...
            <div className="max-w-7xl mx-auto px-8 lg:px-12 w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 relative overflow-visible">
                    ...
                    {FEATURES.filter((_, index) => index === 3 || index === 4).map((feature, idx) => {
                        const originalIndex = idx === 0 ? 3 : 4; // Map back to original indices
                        return (
                            <Container key={feature.title} delay={0.1 + idx * 0.1} className={cn(
                                ...
                                originalIndex === 3 && "lg:col-span-2 order-2",
                                originalIndex === 4 && "order-1",
                            )}>
                                <MagicCard
                                    gradientFrom="#38bdf8"
                                    gradientTo="#3b82f6"
                                ...
                                >
                                    {originalIndex === 3 ? (
                                        ...
                                        <div className="relative w-full aspect-video md:min-h-[400px] md:aspect-auto">
                                        ...
                                        // Testimonial Card for fifth feature
